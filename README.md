...
- **Bump `GAME_VERSION`** when you change cases, items or odds (it's 4 now). Battles only run between games on the server's version, and older games are told to update.
